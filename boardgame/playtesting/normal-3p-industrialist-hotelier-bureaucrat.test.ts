/**
 * Full rules, 3 bots: Industrialist → Hotelier → Bureaucrat (seat order P0..P2).
 *
 *   npm run playtest:normal-3p-ihb
 */
...
const ROSTER: PlayerType[] = ['Industrialist', 'Hotelier', 'Bureaucrat'];

describe('playthrough 3p Industrialist-Hotelier-Bureaucrat', () => {
