/**
 * Full rules, 3 bots: Industrialist → Hotelier → Chieftain (seat order P0..P2).
 *
 *   npm run playtest:normal-3p-ihc
 */
...
const ROSTER: PlayerType[] = ['Industrialist', 'Hotelier', 'Chieftain'];

describe('playthrough 3p Industrialist-Hotelier-Chieftain', () => {
